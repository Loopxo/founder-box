...
export function generatePersonalizedStrategy(
  ...
  const defaultStrategy: PersonalizedStrategy = {
    ...
    recommended_platforms: getPlatformsByAudience(targetAudience),
    content_strategy: getContentStrategy(targetAudience, timeAvail),
    quick_wins: getQuickWins(targetAudience),
    long_term_goals: getLongTermGoals(targetAudience)
  };
...
function getPlatformsByAudience(audience: string): string[] {
...
function getContentStrategy(audience: string, time: string) {
...
function getQuickWins(audience: string): string[] {
...
function getLongTermGoals(audience: string): string[] {
