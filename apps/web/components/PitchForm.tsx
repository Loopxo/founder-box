...
import PDFPreview, { type ProposalTemplatePreview } from "./PDFPreview"
...
export default function PitchForm({ onSubmit, onFormChange }: PitchFormProps) {
  ...
  const [currency] = useState<CurrencyCode>(DEFAULT_CURRENCY)
    ...
    <div className="w-full">
      ...
      {showPreview && (
        <PDFPreview
          ...
          template={industryTemplates[watch('industry') || 'doctors'] as ProposalTemplatePreview}
