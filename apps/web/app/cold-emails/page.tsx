  ...
  return (
    <div style={{ maxWidth: '1100px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <p className="studio-label">Cold Emails</p>
        <h1 className="text-2xl font-bold text-[#EDE9DC]">Template Platform</h1>
      ...
      {activeTab === 'blueprint' && (
        <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '24px', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', position: 'sticky', top: '24px' }}>
            {blueprintSteps.map((step: (typeof blueprintSteps)[number], idx: number) => (
              <button
                key={idx}
