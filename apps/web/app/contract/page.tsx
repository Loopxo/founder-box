...
function ContractContent() {
  ...
  const generateContract = () => {
    ...
    return `${contract}\n\nDISCLAIMER\nThis draft is for informational purposes only and is not legal advice. Review with qualified counsel before signing.`
  }
  ...
  return (
    <div style={{ maxWidth: '1200px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <p className="studio-label">Contracts</p>
        <h1 className="text-2xl font-bold text-[#EDE9DC]">Contract Generator</h1>
                ...
                {!companyLogo ? (
                  ...
                  <div>
	                    <div style={{ background: S.bg, border: `1px solid ${S.border}`, borderRadius: '6px', padding: '16px', textAlign: 'center', marginBottom: '10px' }}>
		                      <Image src={companyLogo} alt="Company Logo" width={160} height={64} unoptimized style={{ maxHeight: '64px', width: 'auto', margin: '0 auto' }} />
                    </div>
                    <button
                      onClick={removeLogo}
