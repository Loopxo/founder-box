  ...
  return (
    <div style={{ maxWidth: '1200px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <p className="studio-label">Invoices</p>
        <h1 className="text-2xl font-bold text-[#EDE9DC]">Invoice Generator</h1>
        <p className="text-sm text-[#9E9880] mt-1 mb-4">
              ...
              {!companyLogo ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
	                  <div style={{ background: S.bg, padding: '16px', borderRadius: '6px', textAlign: 'center', border: `1px solid ${S.border}` }}>
		                    <Image src={companyLogo} alt="Logo" width={160} height={64} unoptimized style={{ maxHeight: '64px', width: 'auto', margin: '0 auto' }} />
                  </div>
