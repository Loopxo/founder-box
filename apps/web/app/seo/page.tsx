    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-sm text-slate-500">
          This tool does not crawl live websites or current search rankings. Use it as an SEO planning framework unless you provide current audit data.
        </p>
      </div>
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                  <h4 className={`font-medium ${item.completed ? 'line-through text-slate-400' : ''}`}>
                                    {item.title}
                                  </h4>
                                  <Badge 
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <div className="grid md:grid-cols-4 gap-4">
                      <div>
                        ...
                        <div className="text-sm text-slate-400">Search Volume: {keyword.searchVolume}</div>
                      </div>
                      <div>
                      ...
                      <div>
                        <div className="text-sm text-slate-400">Est. CPC</div>
                ...
                {marketingChannels.map((channel, index) => (
                  <div key={index} className="border rounded-lg p-4">
                    <div className="grid md:grid-cols-5 gap-4 items-center">
                      ...
                      <div className="text-center">
                        <div className="text-sm text-slate-400">Cost Per Click</div>
                  ...
                  <div key={index} className="border rounded-lg p-6">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="ml-auto">
                        ...
                        <span className="text-sm text-slate-400 ml-1">Savings</span>
                      </div>
                    </div>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="border-t pt-4">
                  <div className="text-center">
                    <div className="text-sm text-slate-400">Projected Annual Revenue Increase</div>
