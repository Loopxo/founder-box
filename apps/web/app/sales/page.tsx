...
Looking forward to hearing from you!`
  ...
  const downloadPlanAsPDF = async () => {
    ...
    try {
        ...
        <html>
          ...
          <body>
            ...
            <div class="section">
              ...
              ${generatedPlan?.plan?.timeline?.weeks?.map((week: TimelineWeek) => `
                <div>
      ...
      toast.success("Plan downloaded", "Your SDR Plan has been downloaded as an HTML file. Open it in any browser or use the browser's print function to convert it to PDF.");
    } catch {
      toast.error("Download failed", "Error downloading plan. Please try again.");
    } finally {
              ...
              <CardContent>
                ...
                <div ref={planRef} className="space-y-8">
                  ...
                  <Card className="bg-[#18181F] border border-[#2A2A38] rounded-sm bg-[#18181F] border border-[#2A2A38] rounded-sm" >
                    ...
                    <CardContent>
                      <div className="space-y-6">
                        {generatedPlan?.plan?.timeline?.weeks?.map((week: TimelineWeek, index: number) => (
